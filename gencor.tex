...
\author[1,2]{Brendan Bulik-Sullivan\thanks{Co-first authors}$^{\dagger}$}
\author[3,*]{Hilary K Finucane}
\author[1,2]{Verneri Antilla}
\author[4,5]{Alexander Gusev}
\author[6]{Felix R. Day}
\author[ ]{the ReproGen Consortium\hspace{-0.7ex}}
\author[6]{John R.B. Perry}
\author[1,2]{Cecilia Lindgren}
\author[1]{Nick Patterson}
\author[1,2]{Elise Robinson}
\author[1,2]{Mark J Daly}
\author[4,5]{Alkes L Price\thanks{Co-last authors}}
\author[1,2,**]{Benjamin M Neale\thanks{Correspondence should be addressed to BBS (bulik@broadinstitute.org) or BMN (bmneale@broadinstitute.org).}}
...
\affil[3]{Department of Mathematics, Massachusetts Institute of Technology, Cambridge, MA, USA.}
\affil[4]{Department of Epidemiology, Harvard School of Public Health, Boston, MA, USA.}
\affil[5]{Department of Biostatistics, Harvard School of Public Health, Boston, MA, USA.}
\affil[6]{MRC Epidemiology Unit, University of Cambridge School of Clinical Medicine, Cambridge, UK}
\date{}
\begin{document}
\maketitle
...
This result is consistent with recent observations that BMI GWAS findings appear to primarily implicate neuronal, rather than metabolic, cell-types and epigenetic marks 
...
Thus, one potential explanation for the apparent genetic correlation between educational attainment and ASD is that this observation is driven by the genetic variants that influence the heavy upper tail of the IQ distribution of individuals with ASD.
...
which may shed some light on emerging differences between the genetic architectures of high IQ and low IQ ASD. 
...
(as a rule of thumb, $Nh^2_g$ should be greater than 3000, where $h^2$ is on the observed scale for case/control studies).
...
or even use pleiotropy to gain power \cite{zhou2014efficient}.
