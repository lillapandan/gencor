...
The simplest LD Score model, with LD Scores computed using only ``genotyped'' SNPs (\emph{i.e.,} HapMap 3 SNPs
\cite{international2010integrating})
...
regions (\cite{}), the observation that low $P$-values for one phenotype tend to predict low $P$-values for another 
