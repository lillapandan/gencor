...
however, our result passes a more rigorous statistical threshold.
Second, we estimate a negative genetic correlation between ulcerative colitis and childhood obesity.
The relationship between premorbid BMI and ulcerative colitis is at present not well-understood (Ramnik Xavier, personal communication),
...
such methods would be biased by sample overlap, and would suffer from the disadvantage that LD-pruning always results in loss of information.
...
but this estimator requires knowing the number of overlapping samples.
