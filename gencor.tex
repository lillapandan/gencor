...
\author[8]{the ReproGen Consortium}
...
Discovering relationships between phenotypes is a fundamental goal of epidemiology, with applications to classification and treatment of disease, as well as to development of pharmaceutical drugs.  
...
Many such methods have the additional advantage that they do not require measuring the same traits on the same individuals, 
which is particularly useful for phenotypes that are rare or costly to assay.  
