...
In addition, we report several novel results, including a positive genetic correlation between anorexia nervosa  and schizophrenia and a negative genetic correlation between anorexia nervosa and body mass. 
...
In addition, we report several novel results, including a positive genetic correlation between anorexia nervosa  and schizophrenia and a negative genetic correlation between anorexia nervosa and BMI. 
These results demonstrate the advantages of a polygenic modeling framework, since there are currently no SNPs associated with anorexia nervosa at genome-wide significance \cite{boraska2014genome}. 
...
Note that this multiple testing correction is conservative, since many of the tests are non-independent.
}}}
\end{centering}
\end{figure}
...
Our estimates of genetic correlations among metabolic traits are consistent with the estimates obtained using REML in Vattikuti \emph{et. al.}
\cite{vattikuti2012heritability} (Supplementary Table \ref{supp-vattikuti}), and are directionally consistent with the recent Mendelian randomization results from \cite{wuertz2014metabolic}.
...
Our estimate of the genetic correlations between schizophrenia and Crohn's disease and ulcerative colitis 
are not statistically significantly different from zero after correction
...
The positive genetic correlation between smoking and obesity is in the opposite direction of the epidemiological association (smoking is associated with lower BMI) and Mendelian randomization results using the nicotine-receptor SNP rs1051730 \cite{aasvold2014causal}.
...
This study measured two phenotypes, years of education and college (yes/no). 
Our estimate of the genetic correlation between these two phenotypes is one, so we present the genetic
correlation results for the college phenotype only, since the results for years of education are identical.
...
The second row of table \ref{table:results} lists results that are, to the best of our knowledge, novel in both genetics and epidemiology.
